...
// Подсказки продажника (раздел «Информация»)
const AGENT_FAQ = [
  { q: 'Где искать клиентов?', a: '4 проверенных канала продаж:\n1. Авито — размещайте объявления по крупным городам, чтобы о вас узнали покупатели по всей России.\n2. Авито — сами пишите продавцам скутеров и предлагайте оптовые закупки: станьте их поставщиком.\n3. Яндекс Карты и 2ГИС — соберите базу магазинов и прокатов, обзванивайте и пишите им с оптовым предложением.\n4. Тематические каналы — публикуйте предложения в чатах и каналах Telegram, сообществах ВКонтакте и других соцсетях.' },
  { q: 'Как начать разговор с клиентом?', a: 'Уточните, какая модель заинтересовала на сайте, какой бюджет и какие цвета. После выяснения модели и цвета скажите, что уточните наличие этой модели и цвета на складе.' },
  { q: 'Как забрать скутер в Москве?', a: 'В Москве доступен самовывоз в коробке — ориентир «Южные ворота». Либо собранный скутер (сборка +7 000 ₽).' },
  { q: 'Нужна ли предоплата при самовывозе?', a: 'Для самовывоза в коробке предоплата не нужна — просто назначаем время (с 10 до 17). Для собранного скутера нужна предоплата 5 000 ₽.' },
  { q: 'Сколько стоит сборка скутера?', a: 'Сборка +7 000 ₽ к цене скутера.' },
  { q: 'Отправляете ли в другие города?', a: 'Да. В другой город отправляем только в коробке — собранный скутер отправить очень дорого (свыше 20 000 ₽). В коробке по России доставка 3 000–7 000 ₽.' },
  { q: 'Как проходит оплата при доставке в другой город?', a: 'Клиент отправляет предоплату 10 000 ₽ как гарантию, что мы можем везти скутер в транспортную компанию (в основном КИТ). Отправляем скутер, присылаем накладную. Клиент проверяет, что товар приняли, и отправляет остаток суммы.' },
  { q: 'Какие цены на сайте?', a: 'На сайте все цены на скутеры в коробках. Есть розничная цена и оптовая — от 3 штук.' },
  { q: 'Скутер на сколько человек?', a: 'Все скутеры на сайте, кроме М8, полноценно для двоих людей. На М8 тоже можно, если люди не сильно крупные.' },
  { q: 'Нужны ли права? Какая маркировка?', a: 'Везде маркировка 49 кубов, без ПТС. Категория прав В или М. Проблем с ДПС нет. Маркировка стоит на двигателе (139 — означает 49 кубов), на шильдике, в сертификате на скутер и в договоре купли-продажи.' },
  { q: 'Какие документы предоставляете?', a: 'Договор купли-продажи предоставим. Плюс сертификат на скутер.' },
  { q: 'Можно ли оплатить при получении?', a: 'Нет. Транспортная компания не предоставляет такую услугу (наложенного платежа нет). Авито-доставки тоже нет — Авито не даёт отправлять скутеры.' },
  { q: 'Можно ли оплатить картой?', a: 'Да, можно оплатить с кредитной карты — к сумме будет +8% (налоги). Оплата по QR-коду дистанционно на ИП.' },
  { q: 'В какие города доставляете и как быстро?', a: 'Доставляем в любой город России. Склад в Москве, сроки зависят от дальности: например, до Сочи — ориентировочно 5–6 дней.' },
  { q: 'Сколько стоит доставка?', a: 'Стоимость рассчитывает транспортная компания перед отгрузкой: по России ориентировочно 3 000–9 000 ₽. В коробке по России — 3 000–7 000 ₽.' },
  { q: 'Какие способы оплаты есть?', a: 'Наличные, USDT или на юридическое лицо. Поможем с любым удобным для клиента способом.' },
  { q: 'Работаете ли с юридическими лицами?', a: 'Да. Для оплаты от юрлица свяжитесь с нами дополнительно — подготовим счёт и все документы.' },
  { q: 'Можно ли купить в кредит?', a: 'Да, у нас более 50 банков-партнёров — поможем оформить кредит или рассрочку. Условия: отсутствие долгов по кредитам и приставам, паспорт РФ. Детали уточняйте у менеджера.' },
  { q: 'Со скольких штук начинается опт?', a: 'Мелкий опт — от 3 штук, розница — от 1 штуки.' },
  { q: 'Есть ли скидка при большом объёме?', a: 'Оптовые цены указаны для каждой модели. При большом объёме — согласуем дополнительную скидку индивидуально.' },
  { q: 'Почему стоит выбрать OUDA?', a: 'Бренд OUDA работает в Китае более 30 лет и отличается отличным качеством деталей.' },
  { q: 'Как клиенту оформить заказ на сайте?', a: 'Выбрать модель, нажать «В корзину», указать количество и нужный цвет, затем оформить заказ в корзине. Как только заявка приходит — мы сразу связываемся с клиентом.' },
  { q: 'Сертификаты прилагаются?', a: 'Да, в комплекте идёт сертификат на 49 см³.' },
  { q: 'Всё ли растаможено?', a: 'Да, скутеры ввозятся официально («в белую»). Все таможенные пошлины уже учтены в цене.' },
]
    ...
    <div className="agent-page">
      <div className="admin-header agent-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <a href={`/${encodeURIComponent(data.agent.code)}`} style={{ fontSize: 13, color: '#667eea' }}>На сайт</a>
      ...
      <div className="admin-content">
        ...
        {/* ИНФОРМАЦИЯ (подсказки продажника) */}
        {tab === 'info' && (
          <div className="agent-crm">
            ...
            <div className="v2-card" style={{ overflow: 'hidden', padding: 0, marginTop: 12 }}>
              {(() => {
                ...
                const list = q ? AGENT_FAQ.filter(f => (f.q + ' ' + f.a).toLowerCase().includes(q)) : AGENT_FAQ
                if (!list.length) return <div style={{ textAlign: 'center', color: '#666', padding: 40 }}>Ничего не найдено. Попробуйте другой запрос (например: «предоплата», «сборка», «права»).</div>
                return list.map((f, i) => (
                  <div key={i} style={{ borderBottom: '1px solid #f0f2ff' }}>
                    <button className="agent-faq-q" onClick={() => setFaqOpen(prev => ({ ...prev, [i]: !prev[i] }))}>
                      <span>{f.q}</span>
                      <span style={{ color: '#999', fontSize: 13 }}>{faqOpen[i] ? '−' : '+'}</span>
                    </button>
                    {faqOpen[i] && <div className="agent-faq-a">{f.a}</div>}
                  </div>
                ))
              })()}
            </div>
            ...
            <form className="agent-client-form" onSubmit={addClient}>
              <div className="agent-crm-grid">
                ...
                <div style={{ position: 'relative' }}>
                  <input className="agent-input" type="date" value={clientForm.pickup_date} onChange={e => setClientForm({ ...clientForm, pickup_date: e.target.value })} style={{ position: 'relative', zIndex: 1 }} />
                  {!clientForm.pickup_date && (
                    <span style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: '#999', fontSize: 14, pointerEvents: 'none', zIndex: 2 }}>Дата самовывоза из Москвы</span>
                  )}
                </div>
