...
const AGENT_FAQ = [
  { q: 'Как начать разговор с клиентом?', a: 'Уточните, какая модель заинтересовала на сайте, какой бюджет и какие цвета. После выяснения модели и цвета скажите, что уточните наличие этой модели и цвета на складе (владелец подтверждает у китайцев на всякий случай).' },
